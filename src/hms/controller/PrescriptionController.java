...
public class PrescriptionController {
	...
	public void loadPrescriptionsFromCsv(String filePath) {
		prescriptionRepository.load(filePath);
	}
	...
	public void addPrescription(Prescription prescription) {
		...
		if (prescriptionRepository.findById(prescriptionId) != null) {
			throw new IllegalArgumentException("Duplicate prescription id: " + prescriptionId);
		}

		prescriptionOutputFileGenerator.generatePrescriptionFile(prescription);
	...
	private void validatePrescription(Prescription prescription) {
		...
		if (isBlank(prescription.getCollectionStatus())) {
			throw new IllegalArgumentException("Collection status is required");
		}
