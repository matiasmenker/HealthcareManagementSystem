...
public class Clinician {
	...
	public Clinician(String id, String firstName, String lastName, String title, String speciality, String gmcNumber,
			String phoneNumber, String email, String workplaceId, String workplaceType, String employmentStatus,
			String startDate) {
		this.id = safe(id);
	...
	public String toString() {
		return "Clinician{id='" + safe(id) + "', firstName='" + safe(firstName) + "', lastName='" + safe(lastName)
				+ "', title='" + safe(title) + "', speciality='" + safe(speciality) + "', workplaceId='"
				+ safe(workplaceId) + "'}";
	}
