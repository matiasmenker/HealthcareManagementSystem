...
public class Referral {
	...
	public Referral(String id, String patientId, String referringClinicianId, String referredToClinicianId,
			String referringFacilityId, String referredToFacilityId, String referralDate, String urgencyLevel,
			String referralReason, String clinicalSummary, String requestedInvestigations, ReferralStatus status,
	...
	public String toString() {
		return "Referral{id='" + safe(id) + "', patientId='" + safe(patientId) + "', referringClinicianId='"
				+ safe(referringClinicianId) + "', referredToClinicianId='" + safe(referredToClinicianId)
				+ "', referringFacilityId='" + safe(referringFacilityId) + "', referredToFacilityId='"
				+ safe(referredToFacilityId) + "', referralDate='" + safe(referralDate) + "', urgencyLevel='"
				+ safe(urgencyLevel) + "', status='" + (status == null ? "" : status.name()) + "'}";
	}
