...
public class StaffTableModel extends AbstractTableModel {
	...
	private final String[] columnNames = new String[] { "Staff ID", "Full Name", "Role", "Department", "Phone", "Email",
			"Work Location", "Shift Pattern", "Employment Status", "Start Date", "Supervisor", "Access Level" };
