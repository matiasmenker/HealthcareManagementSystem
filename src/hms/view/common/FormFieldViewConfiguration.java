...
public class FormFieldViewConfiguration {
	...
	public FormFieldViewConfiguration(String key, String label, boolean required, boolean editable,
			FormFieldInputType inputType, List<SelectionItem> selectionItems) {
	...
	public static FormFieldViewConfiguration requiredSelect(String key, String label,
	...
	public static FormFieldViewConfiguration optionalSelect(String key, String label,
			List<SelectionItem> selectionItems) {
