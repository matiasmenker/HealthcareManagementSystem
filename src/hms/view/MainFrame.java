...
public class MainFrame extends JFrame {
	...
	public MainFrame(PatientController patientController, ClinicianController clinicianController,
		...
		tabbedPane.addTab("Patients", new PatientsPanel(patientController, facilityController, appointmentController,
		...
		tabbedPane.addTab("Referrals",
				new ReferralsPanel(referralController, patientController, clinicianController, facilityController));
