...
public class FacilitiesTableModel extends AbstractTableModel {
	...
	private final String[] columnNames = new String[] { "Facility ID", "Facility Name", "Facility Type", "Address",
			"Postcode", "Phone Number", "Email", "Opening Hours", "Manager Name", "Capacity", "Specialities Offered" };
